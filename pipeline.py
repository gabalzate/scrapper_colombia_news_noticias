...
news_sites_uids = ['wradio', 'eltiempo','marandua','semana','miputumayo','elheraldo','elbaudosenoe','elbaudosenoa','elbaudosenop','elexpreso','lafm','rcnradio','elcolombiano','corrupcionaldia','lavanguardia','lalibertad']
#news_sites_uids = ['lalibertad']
